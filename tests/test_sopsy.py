...
def test_sops_encrypt_json(monkeypatch: pytest.MonkeyPatch, tmp_path: Path) -> None:
...
def test_sops_encrypt_yaml(monkeypatch: pytest.MonkeyPatch, tmp_path: Path) -> None:
    """Test sops.Sops.encrypt function."""
    sops_file = tmp_path / "secret.YAML"
